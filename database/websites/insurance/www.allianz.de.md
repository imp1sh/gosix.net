...
description: Website www.allianz.de IPv6 compatibility
published: true
...
# www.allianz.de IPv6 compatibility
...
Explanation: The domain www.allianz.de has an AAAA record, responds to ping, http and https.
