...
description: Website minecraft.wiki IPv6 compatibility
published: true
...
# minecraft.wiki IPv6 compatibility
...
| Explanation | The domain minecraft.wiki has an AAAA record, responds to ping, http and https. |
