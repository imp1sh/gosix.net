...
description: Website baike.baidu.com IPv6 compatibility
published: true
...
# baike.baidu.com IPv6 compatibility
...
| Explanation | The domain baike.baidu.com has an AAAA record, responds to ping, http and https. |
