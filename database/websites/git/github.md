...
published: true
date: 2024-01-26T09:32:10+00:00
...
| - | - | - |
| rank6, totalfailure :x: :wastebasket: | The domain doesn't even have an AAAA record to begin with. The is the worst ranking a webite can get in the IPv6 database. |  `26.01.2024 10:32:10 CET` |
