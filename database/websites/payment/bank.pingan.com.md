...
description: Website bank.pingan.com IPv6 compatibility
published: true
...
# bank.pingan.com IPv6 compatibility
...
Explanation: The domain bank.pingan.com has an AAAA record, does respond to http and https but not to ping.
