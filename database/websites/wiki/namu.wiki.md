---
title: namu.wiki
description: Website namu.wiki IPv6 compatibility
published: true
...
| Explanation | The domain namu.wiki has an AAAA record, responds to ping, http and https. |
